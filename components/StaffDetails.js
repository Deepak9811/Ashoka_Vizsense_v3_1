...
export default class StaffDetails extends Component {
  ...
  async StaffIN() {
    ...
    if (this.state.slipID !== '') {
      ...
      fetch(
        `https://ashoka.vizsense.in/api/sslog?id=${this.state.employeeId}&mode=1`,
        {
          method: 'POST',
          headers: {
            token: tokenn,
        ...
        .then(result => {
          result.json().then(resp => {
            ...
            if (resp.response === 'success') {
              if (
                resp.message === "Can't check in. Last check out is missing"
              ) {
  ...
  async StaffOut() {
    ...
    if (this.state.slipID !== '') {
      ...
      fetch(
        `https://ashoka.vizsense.in/api/sslog?id=${this.state.employeeId}&mode=2`,
        {
          method: 'POST',
          headers: {
            token: tokenn,
        ...
        .then(result => {
          result.json().then(resp => {
            ...
            if (resp.response === 'success') {
              if (
                resp.message === "Can't check out. Last check in is missing"
              ) {
    ...
    return (
      <Animatable.View
        ...
        <Appbar.Header style={styles.ttl}>
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate('StaffEdit')}>
                        ...
                        <View style={styles.wd}>
                          <LinearGradient
                            ...
                            <TouchableOpacity
                              ...
                              style={styles.btnTouch}>
                              <Text style={styles.empIN}>IN</Text>
