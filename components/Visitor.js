...
export class Profile extends Component {
  ...
  async getVisitorData(s) {
    ...
    if (phoneNumberLength === 10) {
     ...
     Alert.alert("Wrong Input",'Please enter mobile number. ',[{text:'Ok'}],{cancelable:true});
      this.setState({
        loader: false,
      });
    } else if (phoneNumberLength < 10) {
      Alert.alert("Wrong Input",'Please check mobile number. ',[{text:'Ok'}],{cancelable:true});
      this.setState({
        loader: false,
      });
    } else {
      Alert.alert("Wrong Input",'Please insert mobile number. ',[{text:'Ok'}],{cancelable:true});
      this.setState({
        loader: false,
      });
    }
            ...
            <View style={styles.cardShadow}>
              <View style={styles.mgt}>
                <View style={styles.cdm}>
                  ...
                  <Text style={[styles.text_footer,{marginTop:'5%'}]}>Mobile Number</Text>
                  <View
                    style={[
                      styles.action,
                    ...
                    <TouchableOpacity
                      ...
                      {!this.state.loader ? (
                        ...
                        <View
                          ...
                          <ActivityIndicator size="small" color="#0d6efd" style={{marginLeft:10,marginRight:5}}/>
                        </View>
                      )}
                    </TouchableOpacity>
                  </View>
