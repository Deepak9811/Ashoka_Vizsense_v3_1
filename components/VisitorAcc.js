...
async  cameraCapture() {
  ...
  async saveVisitorData() {
    ...
    if (this.state.image1.length !== 0) {
        ...
        .then(result => {
          ...
          result.json().then(async resp => {
            ...
            if (resp.response === 'success') {
              ...
              Alert.alert('Error!', 'Something wents wrong.', [{text: 'Okay'}],{cancelable:true});
              this.setState({
                loader: false,
              });
            }
      ...
      Alert.alert("Alert!","Please click visitor's photo.",[{text:"Ok"}],{cancelable:true})
    }
  }
    ...
    return (
      <SafeAreaView
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={[styles.cr,{marginBottom:windowWidth/4.5}]}>
            <View style={styles.cardShadow}>
              <View style={styles.mgt}>
                <View style={styles.cdm}>
                  <View style={{position:'absolute',top:-25,backgroundColor:"#fff"}}>
                    <Text style={{color: '#959595'}}>
                      Please take the photo of the visitor & other things
                    </Text>
                  </View>

                  <Text style={[styles.fnts,{marginTop:'10%'}]}>
