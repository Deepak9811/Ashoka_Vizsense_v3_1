      ...
      .then(result => {
        result.json().then(async resp => {
          ...
          if (resp.response === 'success') {
            ...
            Alert.alert('', resp.message, [{text: 'Okay'}], {cancelable: true});
          }
        });
      })
      .catch(error => {
          ...
          <View style={styles.cr}>
            <View style={[styles.cdm]}>
              ...
              <View style={{alignItems: 'center'}}>
                <TouchableOpacity
                  style={{borderRadius: 5, borderWidth: 1, marginBottom: '5%'}}
              ...
              <Text style={styles.cl}>
                First Name <Text style={{color: '#FF2020'}}>*</Text>
              </Text>
              ...
              <View style={{marginTop: '5%'}}>
                <Text style={styles.cl}>
                  Mobile <Text style={{color: '#FF2020'}}>*</Text>
                </Text>
                <View style={styles.searchSt}>
                  <TextInput
                    maxLength={10}
              ...
              <View style={{marginTop: '5%'}}>
                <Text style={styles.cl}>
                  Vendor <Text style={{color: '#FF2020'}}>*</Text>
                </Text>
                <View style={styles.searchSt}>
                  <TextInput
                    placeholder="Vendor"
                  ...
                  <View style={styles.wd}>
                    <LinearGradient
                      ...
                      <TouchableOpacity
                        ...
                        style={styles.btnTouch}>
                        <Text style={styles.empIN}>Next</Text>
