...
import Termal_printer from './Termal_printer';
          ...
          <View style={styles.cr}>
            <View style={styles.cardShadow}>
              ...
              {this.state.bluetoothStatus ? (
                <View
                  style={{padding: 10, marginBottom: '5%', marginTop: '10%'}}>
                  <TouchableOpacity
                    style={styles.button}
                    onPress={async () => {
                      try {
                ...
                style={{padding: 10, marginBottom: '5%', marginTop: '10%'}}>
                  <Termal_printer
                    fNmae={this.state.fname}
                    lname={this.state.lname}
                    time={this.state.visitTime}
                    slipId={this.state.text_input}
                    qrCode={this.state.base64Image}
